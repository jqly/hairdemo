...
typedef void (APIENTRYP PFNGLDEPTHRANGEPROC)(GLdouble n, GLdouble forward_);
...
typedef void (APIENTRYP PFNGLDEPTHRANGEFPROC)(GLfloat n, GLfloat forward_);
...
typedef void (APIENTRYP PFNGLDEPTHRANGEINDEXEDPROC)(GLuint index, GLdouble n, GLdouble forward_);
